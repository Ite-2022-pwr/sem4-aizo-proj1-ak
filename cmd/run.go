...
func Run() {
	...
	arraySize := flag.Int("generate", 1000, "ile liczb do wygenerowania.")
	...
	pivot := flag.String("pivot", "lewy", "jakiego pivota do sortowania szybkiego użyć: lewy, prawy, środkowy, losowy.")
	gap := flag.String("gap", "shell", "jakiej metody obliczania odstępu w sortowaniu Shella użyć: shell, franklazarus, hibbard.")
